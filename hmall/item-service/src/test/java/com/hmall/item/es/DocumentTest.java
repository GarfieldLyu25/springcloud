...
public class DocumentTest {
    ...
    @Test
    public void listenItemIndex() throws IOException {
        Item item = itemService.getById(100002672310L);
        ItemDoc itemDoc = BeanUtil.copyProperties(item, ItemDoc.class);
        IndexRequest request = new IndexRequest("items").id("100002672310L");
...
//    }
    ...
    void testBool() throws IOException {
        ...
        // 2.3.品牌过滤
        bool.filter(QueryBuilders.termQuery("brand.keyword", "德亚"));
        // 2.4.价格过滤
